...
namespace HUX.Interaction
{
    public class AppBar : InteractionReceiver
    {
        ...
        public void setScrollView(GameObject scroll)
        {
            m_ScrollView = scroll;
            m_ScrollView.transform.parent = this.transform;
            m_ScrollView.transform.rotation = this.transform.rotation;
            m_ScrollView.transform.position = new Vector3(this.transform.position.x, this.transform.position.y -0.3f, this.transform.position.z);
        }
        ...
        protected override void OnTapped(GameObject obj, InteractionManager.InteractionEventArgs eventArgs) {
            ...
            switch (obj.name) {
                ...
                case "Show Products":
                    State = AppBarStateEnum.ShowProducts;
                    openScrollView();
                    break;
